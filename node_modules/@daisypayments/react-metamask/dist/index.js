...
function createMetaMaskContext(initial = null) {
  ...
  class MetaMaskContextProvider extends React.Component {
    ...
    render() {
      ...
      return React__default.createElement(ContextProvider, _extends({}, props, {
        value: internalValue
      }));
    }
...
function withMetaMask(MetaMaskContext) {
  return function withMetaMaskContext(Comp) {
    const ComponentWithMetaMask = React__default.forwardRef((props, ref) => React__default.createElement(MetaMaskContext.Consumer, null, metamask => React__default.createElement(Comp, _extends({
      ref: ref,
      metamask: metamask
    }, props))));
...
exports.MetaMask = MetaMask$1;
exports.PropTypesMetaMask = PropTypesMetaMask;
exports.PropTypesMetaMaskObject = PropTypesMetaMaskObject;
exports.createMetaMaskContext = createMetaMaskContext;
exports.withMetaMask = withMetaMask;
